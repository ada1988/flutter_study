...
import 'package:reyuan_version/common/util/image_utils.dart';
...
class _SplashPageState extends State<SplashPage> {
  ...
  void _initSplash() {
    _subscription = Observable.just(1).delay(Duration(milliseconds: 2500)).listen((_) {
      if (SpUtil.getBool(Constant.keyGuide, defValue: true)) {
        //教程仅一次，暂时关闭
  ...
  Widget build(BuildContext context) {
    return Material(
      ...
      child: _status == 0 ? FractionallyAlignedSizedBox(
        ...
        //leftFactor: 0.33,
        //bottomFactor: 0,
        child: const LoadAssetImage('start')
      ) :
      Swiper(
